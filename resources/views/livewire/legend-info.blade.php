<div class="flex flex-wrap items-center gap-4 px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-lg mb-4 border border-gray-200 dark:border-gray-700">
    @unless(auth()->user()->hasRole('Client'))
        <!-- Urgent + Assigned to You (hidden for clients) -->
    ...
    <!-- Urgent Ticket (shown for all roles including clients) -->
    <div class="flex items-center gap-4">
    ...
    @unless(auth()->user()->hasRole('Client'))
        <!-- Assigned to You (hidden for clients) -->
        <div class="flex items-center gap-4">
    ...
    <!-- Requested Tickets (shown for all roles including clients) -->
    <div class="flex items-center gap-4">
